...
const DocumentDetail = () => {
  ...
  useEffect(() => {
    if (document && userId && tenantRole && !loading) {
  ...
  }, [document, userId, tenantRole, userRole, loading])
        ...
        <main className="flex-1 p-6 lg:p-10">
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div className="xl:col-span-1">
              <div className="card bg-base-100 shadow-sm border border-slate-200/60 sticky top-6 max-h-[calc(100vh-2.5rem)] flex flex-col">
