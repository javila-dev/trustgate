...
const Home = () => {
  ...
  const folderDocumentCounts = documents.reduce((acc, doc) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
            ...
            <div className="group relative bg-white p-6 rounded-2xl border border-slate-200/60 shadow-sm hover:shadow-md hover:border-slate-300 transition-all duration-200">
              <div className="flex items-start justify-between">
                ...
                <div className="w-12 h-12 bg-gradient-to-br from-slate-100 to-slate-50 rounded-xl flex items-center justify-center ring-1 ring-slate-200/50">
