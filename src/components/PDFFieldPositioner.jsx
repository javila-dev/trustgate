...
const PDFFieldPositioner = ({ file, signers, onFieldsChange, initialFields = [] }) => {
  ...
  const renderField = (field, pageNumber) => (
    <div
      ...
      onMouseDown={(e) => handleMouseDown(field.id, pageNumber, e)}
  ...
  return (
    <div className="flex flex-col lg:flex-row-reverse gap-6 h-full">
      {/* Left Panel - Controls */}
      <div className="w-full lg:w-64 space-y-3 flex-shrink-0 h-full overflow-y-auto pr-2 pb-6">
        {/* Signer Selection */}
      ...
      <div className="flex-1 bg-slate-100 rounded-lg overflow-hidden border border-slate-200 flex flex-col min-w-0">
              ...
              {numPages && Array.from({ length: numPages }, (_, index) => {
                ...
                return (
                  <div
                    ...
                    onClick={(e) => addField(pageNumber, e)}
                    style={{ cursor: draggedFieldId ? 'grabbing' : 'crosshair' }}
                  >
